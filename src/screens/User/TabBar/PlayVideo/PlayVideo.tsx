...
const PlayVideo = ({currentStep = 1}: KnownTypes) => {
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                لقد كان الكورس مذهلاً! تعلمت الكثير من المهارات الجديدة في
                الخياطة وأصبح بإمكاني الآن تصميم وتنفيذ ملابسي بنفسي. المدربون
                كانوا رائعين ودروسهم سهلة الفهمs
              </Text>
            </View>
          </View>
          <CustomTrackPlayer />
